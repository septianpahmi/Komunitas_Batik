        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div class="lg:py-24">
                ...
                <p class="mt-4 text-gray-600">
                    ...
                    Organization
                    (UNESCO) berkembang di seluruh nusantara dan menjadi karya budaya yang mewakili identitas
            ...
            <div
                ...
                <div class="bg-white bg-opacity-75 p-4 rounded-lg">
                    ...
                    <p class="mt-2 text-gray-600">
                        <b>Dahlia Batik Genturan Cianjur</b> memiliki visi untuk perkembangannya di masa depan,
                        yakni melestarikan dan menumbuhkan batik sebagai salahsatu upaya untuk meningkatkan
                        kesejahteraan masyarakat, dan menumbuhkan industri kerajinan batik di cianjur dengan menjadi
                        perusahaan penghasil dan pengolah batik yang memiliki nilai seni dan nilai jual tinggi,
                        serta dapat bersaing dan dikenal oleh masyarakat dalam dan luar negeri.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="bg-white bg-opacity-75 p-4 rounded-lg">
                    ...
                    <ul class="mt-2 list-disc list-inside text-gray-600">
                        ...
                        <li>Memperkaya motif batik Cianjuran untuk menambah perbendaharaan motif-motif yang sudah
                            ada.</li>
                        <li>Melakukan inovasi dalam hal desain produk dengan mengikuti perkembangan yang ada</li>
                        <li>Meningkatkan kualitas sumber daya manusia dengan cara mendidik tenaga-tenaga terampil
                            dan produktif</li>
                        <li>Meningkatkan kesejahteraan karyawan melalui lingkungan tempat kerja dan tempat tinggal
                            yang bersih dan sehat, memberikan upah sesuai dengan keahlian dan prestasi kerja</li>
                        <li>Meningkatkan kualitas dan daya saing yang berpotensi untuk memasuki pasar global.</li>
                        <li>Memperluas jaringan melalui kerjasama dengan pusat-pusat kerajinan batik melalui
                            pertukaran informasi desain dan proses produksi</li>
            ...
            <div class="why_items bg-gray-100 rounded-lg p-6 shadow-md">
                ...
                <div class="why_us_text text-center">
                    ...
                    <p class="text-gray-700">
                        Perusahaan kami berkomitmen untuk menyediakan batik berkualitas tinggi yang dibuat dengan
                        teknik tradisional dan bahan terbaik. Setiap motif dan corak yang dihasilkan merupakan hasil
                        karya tangan para pengrajin berpengalaman, memastikan bahwa setiap produk mencerminkan
                        keaslian dan nilai budaya yang mendalam.
                    </p>
                </div>
            </div>
            <div class="why_items bg-gray-100 rounded-lg p-6 shadow-md">
                ...
                <div class="why_us_text text-center">
                    ...
                    <p class="text-gray-700">
                        ...
                        untuk memastikan mereka mendapatkan penghasilan yang layak dan mendukung kelestarian seni
                        batik yang telah diwariskan turun-temurun.
                    </p>
                </div>
            </div>
            <div class="why_items bg-gray-100 rounded-lg p-6 shadow-md">
                ...
                <div class="why_us_text text-center">
                    ...
                    <p class="text-gray-700">
                        ...
                        pribadi mereka, baik untuk penggunaan sehari-hari, acara formal, atau sebagai hadiah
                        spesial. Kami juga menerima pesanan khusus untuk memenuhi kebutuhan desain yang unik.
                    </p>
                </div>
            </div>
        </div>
...
<section class="bg-gray-100 py-16">
    <div class="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-extrabold text-center text-gray-800 mb-8">
            Kegiatan Dahlia Batik Genturan
        </h2>
